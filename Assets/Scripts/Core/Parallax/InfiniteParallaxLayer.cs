...
namespace Core.Parallax
{
    public class InfiniteParallaxLayer
    {
        ...
        {
            Transform activeLayer = _layers.Find(layer => IsPlayerActive(layer, targetPosition));
            Transform layerToMove = _layers.Find(layer => !IsPlayerActive(layer, targetPosition));
        ...
        private bool IsPlayerActive(Transform layer, float targetPosition) =>
